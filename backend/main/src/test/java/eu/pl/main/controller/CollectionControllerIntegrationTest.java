...
@WebMvcTest(controllers = CollectionController.class, excludeAutoConfiguration = {SecurityAutoConfiguration.class})
class CollectionControllerIntegrationTest {
    ...
    void getAllCollections_shouldReturnListOfCollections() throws Exception {
        ...
        when(collectionService.getAllCollectionsForUser(ownerId)).thenReturn(mockCollections);
    ...
    void getAllCollections_shouldReturnEmptyList_whenNoCollectionsExist() throws Exception {
        ...
        when(collectionService.getAllCollectionsForUser(ownerId)).thenReturn(Collections.emptyList());
